...
export const apiRoutes = {
  ...
  auth: {
   ...
   doctors: {
    ...
    createWithUser: `${API_URL}/doctors/create-with-user-and-schedule`,
    edit: `${API_URL}/doctors/:id`,
    editWithUser: `${API_URL}/doctors/update-with-user-and-schedule/:userId`,
    details: `${API_URL}/doctors/:id`,
    delete: `${API_URL}/doctors/:id`,
    deleteDoctorByUserId: `${API_URL}/doctors/delete-with-user-and-schedule/:userId`,
  },
   appointments: {
